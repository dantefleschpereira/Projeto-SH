...
INSERT INTO [dbo].[Produtos] ([ProdutoId], [Nome], [Descricao], [Preco], [StatusVenda], [CategoriaID], [Cidade], [UsuarioId], [DataVenda]) 
VALUES (11, N'Prancha de snowboard', N'Prancha da marca Burton', CAST(500.00 AS Decimal(18, 2)), 1, 4, N'Capão da Canoa', 6, CAST(N'2021-01-10 10:38:09.000' AS DateTime))

INSERT INTO [dbo].[Produtos] ([ProdutoId], [Nome], [Descricao], [Preco], [StatusVenda], [CategoriaID], [Cidade], [UsuarioId], [DataVenda]) 
VALUES (12, N'Skate', N'Skate da marca Drop Dead', CAST(400.00 AS Decimal(18, 2)), 1, 4, N'Capão da Canoa', 6, CAST(N'2021-01-05 07:38:09.000' AS DateTime))
